...
(define-key space-map "ot" 'org-set-tags)
(evil-define-key '(normal insert) org-mode-map (kbd "C-SPC") 'org-todo)
...
(evil-define-key '(normal insert) org-capture-mode-map (kbd "C-SPC") 'org-todo)
