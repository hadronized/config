...
local lsp_attach = function(args)
  return function(client, bufnr)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>ca', '<cmd>Telescope lsp_code_actions theme=get_dropdown previewer=false<cr>', {})
    ...
    vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>cx', '<cmd>Telescope lsp_workspace_diagnostics theme=get_dropdown<cr>', {})
